...
# Story Advantage delivery process

The end-to-end pipeline (almost) every [[Story Advantage Marketing Agency]] client runs through — diagnosis → message → structure → look → build. Each stage feeds the next, and the whole thing operationalises the [[Brand Resonance System]] (Differentiate → Integrate → Activate).

## The stages, in order

1. **[[Comprehensive Marketing Review|Marketing Review]]** — MMR / CMR / SMS. Diagnose where the marketing is weak and what to fix. *(Differentiate)*
